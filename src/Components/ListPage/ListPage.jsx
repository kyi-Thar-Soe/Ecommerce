...
export default function ListPage({ data }) {
  ...
  return (
    <div>
      <div className=" d-flex flex-wrap justify-content-between mt-5 mb-5 container">
        {data?.map((item, index) => {
          return (
            <Card
              style={{ width: "18rem" }}
              key={index}
              className="mb-3 border-0 items"
            >
              ...
              <CardBody>
                ...
                <CardFooter>
                  <button
                    className="btn btn-outline-secondary me-3 buy_Button text-dark"
