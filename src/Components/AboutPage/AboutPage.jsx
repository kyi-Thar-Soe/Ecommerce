    ...
    <>
     <Modal isOpen={aboutModal} toggle={toggleAbout} className="about-div">
        ...
        <div className="text-warning d-flex justify-content-between mt-3">
            <span className='ribbon'><img src="https://tinyurl.com/2ojk7qxa" alt="curly ribbon" style={{width: "200px",height: "50px"}}/></span>
